...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white dark:bg-gray-900 sticky top-0 z-50 pt-4 pb-3">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative grid grid-cols-2 sm:grid-cols-3">
          <div className="hidden sm:block"></div>
          <div className="flex flex-col items-start sm:items-center justify-center pointer-events-none">
            <Link
              href="/"
            ...
            >
              <span className="text-base-700 dark:text-base-500">breaddie</span>
            </Link>
          ...
          <div className="flex items-center justify-end gap-2 sm:gap-4 sm:ml-6 sm:pr-0">
            <button
              type="button"
